...
public class ViewerFrame extends JFrame
{
	...
	public JPanel createToolPanel()
	{
		...
		// 工具数组
		String[] toolarr = { "action.OpenAction", "action.LastAction", "action.NextAction", "action.BigAction",
				"action.SmallAction" };
	...
	public void createMenuBar()
	{
		...
		// 菜单项文字数组
		String[][] menuItemArr = { { "打开(O)", "-", "退出(X)" }, { "放大(M)", "缩小(O)", "-", "上一个(X)", "下一个(P)" },
				{ "帮助主题", "关于" } };
